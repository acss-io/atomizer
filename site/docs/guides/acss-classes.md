...
<p>Simple <b class="Fw(b)">ACSS</b> classes are easily interpreted, since they take a simple value as a parameter.  For example, <code>W(<b>20px</b>)</code> clearly maps to <code>width: 20px</code>, and <code>Lh(<b>1.5</b>)</code> clearly maps to <code>line-height: 1.5</code>.</p>
