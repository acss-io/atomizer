...
<div class="Cf">
   <div class="Bxz(bb) Fl(start) W(50%) P(20px) Bgc(--example-box-1)">Box 1</div>
   <div class="Bxz(bb) Fl(start) W(50%) P(20px) Bgc(--example-box-4)">Box 2</div>
</div>
...
<div class="D(tb) W(100%) Ta(c)" role="presentation">
    <div class="D(tbc) Va(m) P(20px) Bgc(--example-box-1)">Box Number 1</div>
    <div class="D(tbc) Va(m) P(20px) Bgc(--example-box-2)">Box Number 2</div>
    <div class="D(tbc) Va(m) P(20px) Bgc(--example-box-3)">Box Number 3</div>
    <div class="D(tbc) Va(m) P(20px) Bgc(--example-box-4)">Box Number 4</div>
</div>
...
<div class="D(tb) W(100%) Va(m) Ta(c)" dir="rtl" role="presentation">
    <div class="D(tbc) Va(m) P(20px) Bgc(--example-box-1)">Box <br />Number <br />1</div>
    <div class="D(tbc) Va(m) P(20px) Bgc(--example-box-2)">Box Number 2</div>
    <div class="D(tbc) Va(m) P(20px) Bgc(--example-box-3)">Box Number 3</div>
    <div class="D(tbc) Va(m) P(20px) Bgc(--example-box-4)">Box Number 4</div>
</div>
...
<div class="D(tb) W(100%) Ta(c)" role="presentation">
    <div class="D(tbfg) P(20px) Bgc(--example-box-2)">Box Number 1</div>
    <div class="D(tbc) P(20px) Bgc(--example-box-3)">Box Number 2</div>
    <div class="D(tbhg) P(20px) Bgc(--example-box-4)">Box Number 3</div>
</div>
...
<div class="D(f) Jc(sb)">
    <div class="W(100px) Lh(100px) Ta(c) Bgc(--example-box-1)">Box 1</div>
    <div class="W(100px) Lh(100px) Ta(c) Bgc(--example-box-2)">Box 2</div>
    <div class="W(100px) Lh(100px) Ta(c) Bgc(--example-box-3)">Box 3</div>
    <div class="W(100px) Lh(100px) Ta(c) Bgc(--example-box-4)">Box 3</div>
</div>
...
<div class="D(g) Gtc(twoColNamedGrid) Bgc(--color-code-bg) Bd Bdc(--color-code-bd) P(10px) Gp(10px) Mt(20px)">
    <div class="Bgc(--example-box-1) P(10px) Ga(colMain) Mih(150px)">1</div>
    <div class="Bgc(--example-box-4) P(10px) Ga(colAside) Mih(150px)">2</div>
</div>
...
<div class="D(g) Gac(gridMinMax) Gar(150px) Bgc(--color-code-bg) Bd Bdc(--color-code-bd) P(10px) Gp(10px) Mt(20px)">
    <div class="Bgc(--example-box-1) P(10px)">1</div>
    <div class="Bgc(--example-box-3) P(10px) Gc(3)">2</div>
    <div class="Bgc(--example-box-2) P(10px) Gc(5)">3</div>
    <div class="Bgc(--example-box-4) P(10px)">4</div>
    <div class="Bgc(--example-box-3) P(10px)">5</div>
    <div class="Bgc(--example-box-1) P(10px)">6</div>
</div>
...
<div class="D(g) Gtc(threeColEvenGrid) Gaf(rd) Bgc(--color-code-bg) Bd Bdc(--color-code-bd) P(10px) Gp(10px) Mt(20px)">
    <div class="Bgc(--example-box-1) P(10px)">1</div>
    <div class="Bgc(--example-box-4) P(10px) Gc(twoCol)">2</div>
    <div class="Bgc(--example-box-3) P(10px)">3</div>
    <div class="Bgc(--example-box-4) P(10px)">4</div>
    <div class="Bgc(--example-box-2) P(10px) Gc(twoCol)">5</div>
    <div class="Bgc(--example-box-1) P(10px)">6</div>
</div>
...
<div class="D(g) Gtc(threeColEvenGrid) Gar(50px) Bgc(--color-code-bg) Bd Bdc(--color-code-bd) P(10px) Gp(10px) Mt(20px)">
    <div class="Bgc(--example-box-1) P(10px) Gr(twoCol)">1</div>
    <div class="Bgc(--example-box-4) P(10px) Gc(twoCol) Gr(4)">2</div>
    <div class="Bgc(--example-box-3) P(10px)">3</div>
    <div class="Bgc(--example-box-4) P(10px) Gr(twoCol)">4</div>
    <div class="Bgc(--example-box-2) P(10px) Gc(twoCol)">5</div>
    <div class="Bgc(--example-box-1) P(10px) Gc(2)">6</div>
</div>
...
<div class="D(g) Gtc(threeColEvenGrid) Gar(50px) Bgc(--color-code-bg) Bd Bdc(--color-code-bd) P(10px) Gp(10px) Mt(20px)">
    <div class="Bgc(--example-box-1) P(10px) Gcs(2)">1</div>
    <div class="Bgc(--example-box-4) P(10px) Gcs(spanTwo)">2</div>
    <div class="Bgc(--example-box-3) P(10px)">3</div>
    <div class="Bgc(--example-box-2) P(10px) Gce(4)">4</div>
    <div class="Bgc(--example-box-1) P(10px)">5</div>
    <div class="Bgc(--example-box-4) P(10px)">6</div>
</div>
...
<div class="D(g) Gtc(threeColEvenGrid) Gar(50px) Bgc(--color-code-bg) Bd Bdc(--color-code-bd) P(10px) Gp(10px) Mt(20px)">
    <div class="Bgc(--example-box-1) P(10px) Grs(2)">1</div>
    <div class="Bgc(--example-box-3) P(10px) Grs(spanTwo)">2</div>
    <div class="Bgc(--example-box-1) P(10px)">3</div>
    <div class="Bgc(--example-box-1) P(10px) Gre(1)">4</div>
    <div class="Bgc(--example-box-4) P(10px)">5</div>
    <div class="Bgc(--example-box-4) P(10px)">6</div>
</div>
...
<div class="D(g) Gt(gridABCUnit) Bgc(--color-code-bg) Bd Bdc(--color-code-bd) P(10px) Gp(10px) Mt(20px)">
    <div class="Bgc(--example-box-1) P(10px) Ga(gridHeader)">1</div>
    <div class="Bgc(--example-box-3) P(10px) Ga(gridNav)">2</div>
    <div class="Bgc(--example-box-4) P(10px) Ga(gridContent)">3</div>
</div>
...
<div class="D(g) Gta(gridABC) Bgc(--color-code-bg) Bd Bdc(--color-code-bd) P(10px) Gp(10px) Mt(20px)">
    <div class="Bgc(--example-box-1) Ga(gridHeader) P(10px)">1</div>
    <div class="Bgc(--example-box-3) Ga(gridNav) P(10px)">2</div>
    <div class="Bgc(--example-box-4) Ga(gridContent) P(10px)">3</div>
</div>
...
<div class="D(g) Gtc(threeColEvenGrid) Gtr(rowOneFixed) Bgc(--color-code-bg) Bd Bdc(--color-code-bd) P(10px) Gp(10px) Mt(20px)">
    <div class="Bgc(--example-box-1) P(10px)">1</div>
    <div class="Bgc(--example-box-4) P(10px)">2</div>
    <div class="Bgc(--example-box-3) P(10px)">3</div>
    <div class="Bgc(--example-box-3) P(10px)">4</div>
    <div class="Bgc(--example-box-2) P(10px)">5</div>
    <div class="Bgc(--example-box-4) P(10px)">6</div>
</div>
