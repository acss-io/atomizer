...
Traditional style sheets may be helpful for styles that Atomic cannot create <b class="Fw(n)">[\[1\]](#footnote)<a id="footnote-1" class="D(ib)"></a></b>, styles for elements that aren't under your application's control, or repeating elements that are not componentized <b class="Fw(n)">[\[2\]](#footnote)<a id="footnote-2" class="D(ib)"></a></b>.
