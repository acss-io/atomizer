        ...
        var linkHTML = Object.keys(links).map(function (name, index) {
            ...
            return name !== 'home' ? (
                <li className={className} key={link.path}>
                    <NavLink routeName={link.page} context={context} className="D-b C-fff Td-n:hover" navParams={navParams}>
                        <b className="Pos-r">
                            {link.label}
                        </b>
                    </NavLink>
        ...
        return (
            <ul role="navigation" className="Va-m Reset">
                ...
                <li className="D-ib Mstart-10px Pos-r">
                    <a className="D-b C-fff Td-n:hover" href="https://github.com/yahoo/atomizer">
