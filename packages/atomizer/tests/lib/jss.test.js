...
describe('JSS', () => {
    ...
    describe('extractedToStylesheet()', () => {
        it(
            'should return a stylesheet object given an extracted object',
            () => {
    ...
    describe('jssToCss()', () => {
        ...
        it(
            'should return CSS with combined selectors given a CSS Object',
            () => {
                const result = JSS.jssToCss({
                    'body': {
                        'background': 'black',
        ...
        it(
            'should return CSS with media query blocks placed after the main block',
            () => {
                const result = JSS.jssToCss({
                    '.W\(100\%\)--sm': {
        ...
        it(
            'should return CSS with media query blocks ordered by media query not by property name',
            () => {
                const result = JSS.jssToCss({
                    '.C\(#000\)--md': {
